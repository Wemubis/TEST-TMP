...
(mise en forme, DataTables, exports) et on remplit le tableau nous-mêmes, avec
deux colonnes en plus : Machine et Image, ajoutées EN FIN de tableau car le
template référence ses colonnes par index de 0 à 9.
